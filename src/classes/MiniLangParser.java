 ...
 */
public class MiniLangParser extends src.classes.beaver.Parser {

	static final ParsingTables PARSING_TABLES = new ParsingTables(
		"U9nraLbFmp0GX2TnKWWfIPkKSaRYgH82SKaW8Iw9D$uLFnaeLw6mZ3SRuGVgwFEE9#jh3U0" +
		"UcNo88CSg4gnX18UOtbmUrSkmX6LLFGmnm0fg#TAi7QoRr$RUIr6gNjJ$PMwZpxKBKc6CBM" +
		"p83C2clCidpv5I#trJxbTmxa2zMhs4CmjL4K$ggFtPsgoXUTqVxuNEehxDBBXsIyuLAwIiI" +
		"yQlnzCq3z3MaBYLs3Kl8HFYy$RCEo0Nv8XSUi$yKv9xBI9pXdDIaojoJMx96RaXTvOt2#QF" +
		"0#qiPXOFBHvtETsUuTYyFZa9nlk1Rkn#a6$vaQdfD$9ANcGgp#eyuRzMyZuHg#b8p97Zgq1" +
		"VfcI5IiQAVg5LxuWCXz4lrxv3V0==");
	...
	public MiniLangParser() {
		...
		actions = new Action[] {
			...
			RETURN3,	// [11] Expr = Expr.a DIV Expr.b; returns 'b' although more are marked
			new Action() {	// [12] Expr = ID.v
				public Symbol reduce(Symbol[] _symbols, int offset) {
			...
			new Action() {	// [14] Expr = AP Expr.e FP
				public Symbol reduce(Symbol[] _symbols, int offset) {
